/*
Question: What are the most optimal skills to learn (aka it's in high demand and a 
high-paying skill)?
...
-- rewriting the same more concisely
...
-- rewriting the same using job_local San Francisco
